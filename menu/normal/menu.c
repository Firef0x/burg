...
GRUB_EXPORT(grub_menu_register_viewer);
GRUB_EXPORT(grub_gfxmenu_try_hook);
GRUB_EXPORT(grub_menu_get_entry);
...
grub_err_t
grub_normal_show_menu (grub_menu_t menu, int nested)
{
