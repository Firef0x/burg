...
extern int grub_ieee1275_map_physical (grub_addr_t paddr,
				       grub_addr_t vaddr,
				       grub_size_t size,
				       grub_uint32_t mode);
extern int grub_ieee1275_claim_vaddr (grub_addr_t vaddr,
				      grub_size_t size);
extern int grub_ieee1275_alloc_physmem (grub_addr_t *paddr,
					grub_size_t size,
					grub_uint32_t align);
